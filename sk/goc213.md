...
sudo apt install python3-impacket impacket-scripts python3-dsinternals crackmapexec python3-pip -y
pip3 install mitm6 minikerberos impacket adidnsdump certipy bloodhound coercer
