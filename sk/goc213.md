...
```cmd
\\local\GOC213\PingCastle_3.1.0.0\pingcastle.exe --healthcheck --server contoso.com --user CONTOSO\bfu --password 'Pa$$w0rd' --protocol LDAPOnly --quota 10 --level Full --no-enum-limit --explore-trust --explore-forest-trust  --datefile
```
