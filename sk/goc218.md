...
### Task 4.2: Create a Conditional Access Policy
...
### Task 4.3: Create a script running as a scheduled tasks
...
### Task 4.5 Register the PIN Reset app

### Task 4.6: Deploy Azure AD Application Proxy
...
1. Launch the `E:\GOC218\PingCastle_3.1.0.1\PingCastle.exe` application.
