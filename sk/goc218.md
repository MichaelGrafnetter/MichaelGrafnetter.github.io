...
2. Add the https://autologon.microsoftazuread-sso.com site to the Intranet Zone.
3. Visit the domain-specific URL of the Azure Portal: https://portal.azure.com/givenname.lab.dsinternals.com
...
### Task 3.2: Enable FIDO2 Hybrid and WHfB Cloud Trust
...
- Check the device properties in https://endpoint.microsoft.com.
 ...
 ### Task 3.7: Cloud-registered PC


### Task 3.8: Enable Device Writeback
