...
2. Configure Group Writeback in Entra ID Connect on **GOC218-SYNC**:
...
3. Create a security group called `Research and Development` in Entra ID.
...
### Task 2.10: Roll-over Entra ID Connect secrets (Optional)
