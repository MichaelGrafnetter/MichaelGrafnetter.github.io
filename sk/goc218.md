...
2. Change the UPN suffix of the following AD accounts to XXXX.goc218.dsinternals.com using the Active Directory Users and Computers console:
    - park
    - kirkland
    - galloway
    - simmons
...
### Task 2.8: Enable federation with AD FS (Optional)
