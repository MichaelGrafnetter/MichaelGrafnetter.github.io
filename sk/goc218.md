...
1. Configure Group Writeback in Azure AD Connect on GOC218-SYNC:
...
2. Run the `Get-ADSyncAADCompanyFeature` cmdlet and check that `GroupWritebackV2` is `True`.
...
6. Checking the presence of the group on-prem AD on GOC218-DC.
