...
### Task 1.5: Create Groups in Entra ID

> [!TODO]
> This assignment needs to be expanded.

1. M365 group.
2. Dynamic security group.
3. Assign license to group.

### Task 1.6: Administrative Units
...
1. Open the [Microsoft Intune admin center](https://endpoint.microsoft.com).
...
4. Configure the new policy with the following parameters:
   ...
   * Configuration settings:
     ...
     * Administrative Templates Windows Components &rArr; Internet Explorer &rArr; Internet Control Panel &rArr; Security Page
       **Site to Zone Assignment List (Device)**:
...
* Check the device properties in the [Microsoft Intune admin center](https://endpoint.microsoft.com).
