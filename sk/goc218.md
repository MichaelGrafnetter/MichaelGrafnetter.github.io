...
& '\\local\GOC218\AzureADConnectSyncDocumenter\AzureADConnectSyncDocumenterCmd.exe' Staging Production
```
...
- Use the default `XXXX.onmicrosoft.com` account to reconfigure AD Connect.
