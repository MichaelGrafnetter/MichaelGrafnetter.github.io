...
Create a Named Location called HQ and configure it with the public IP address of the GOC218-PC4 VM.

Create a Conditional Access Policy that allows access to the Claims X-Ray app only from the HQ.

Test the policy on your local computer and on GOC218-PC4 as AdeleV.
